...
router.post('/popbill/v1/easyfinbank/getTransactionHistory', EasyFinBankController.getTransactionHistory)
router.post('/popbill/v1/easyfinbank/requestJob', EasyFinBankController.requestJob)

/* 카톡 */
router.post('/popbill/v1/kakao/listPlusFriendID', KakaoController.listPlusFriendID)
router.post('/popbill/v1/kakao/getPlusFriendMgtURL', KakaoController.getPlusFriendMgtURL)
router.post('/popbill/v1/kakao/getATSTemplateMgtURL', KakaoController.getATSTemplateMgtURL)
