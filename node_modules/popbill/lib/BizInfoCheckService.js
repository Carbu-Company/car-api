...
BizInfoCheckService.prototype.joinMember = function(JoinForm, success, error) {
...
BizInfoCheckService.prototype.getCorpInfo = function(CorpNum, UserID, success, error) {
    if (this._isNullOrEmpty(CorpNum)) {
        this._throwError('팝빌회원 사업자번호가 입력되지 않았습니다.', error)
        return
    }
...
BaseService.addMethod(BizInfoCheckService.prototype, 'getCorpInfo', function(CorpNum, success, error) {
...
BaseService.addMethod(BizInfoCheckService.prototype, 'joinMember', function(JoinForm, success, error) {
    this.joinMember(JoinForm, '', success, error)
})

BizInfoCheckService.prototype.getUnitCost = function(CorpNum, success, error) {
    if (this._isNullOrEmpty(CorpNum)){
        this._throwError('팝빌회원 사업자번호가 입력되지 않았습니다.', error)
        return
    }
