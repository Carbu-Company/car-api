...
// 알선 목록 조회 
exports.getCarSelConcilList = async ({ 
    agentId, 
    page,
    pageSize,
    carNo,
...
*/
  ...
  // 알선 합계 조회
  exports.getCarSelConcilSummary = async ({  
    agentId, 
    page,
    pageSize,
    carNo,
  ...
  // 알선 상세 조회
  exports.getCarSelConcilInfo = async ({ carRegId }) => {
    try {
      const request = pool.request();
...
// 알선 판매 등록
exports.insertCarSelConcil = async ({
  agentId,                                                  // 상사 ID              
  dealerId,                                                  // 판매딜러 ID
  tradeItemCd,                                               // 거래항목 코드
  brkSaleDt,                                                 // 알선판매일  
...
// 알선 판매 수정
exports.updateCarSelConcil = async ({
  brkSeq,                                                    // 알선 판매 순번
  agentId,                                                  // 상사 ID              
  dealerId,                                                  // 판매딜러 ID
  tradeItemCd,                                               // 거래항목 코드
